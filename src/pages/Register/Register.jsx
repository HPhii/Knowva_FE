              ...
              <div className="max-w-md mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[var(--color-blue)] !text-white py-3 px-4 rounded-lg font-semibold hover:bg-[var(--color-blue-hover)] transition-colors duration-200 disabled:bg-[var(--color-grey-dark)] disabled:cursor-not-allowed"
                  >
                    {loading
