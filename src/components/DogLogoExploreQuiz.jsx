...
import quizShiba from "../../src/assets/images/quiz_shiba.png";
  ...
  return (
    <div>
      <div className="relative w-fit">
        ...
        />
        <div
          className={`absolute !w-22 !h-22 z-10 top-[-10px] left-[-4px] w-full h-full bg-[#FFE100] blur-md rounded-full opacity-50 duration-300 z-10 transition-all duration-300 ${
            activeTab === "quiz" ? "!opacity-50 delay-400" : "!opacity-0"
          }`}
        ></div>

        <div
          className={`absolute rotate-20 top-[-6px] left-[-6px] transition-all duration-500 z-20 ${
            activeTab === "quiz" ? "opacity-100 delay-400" : "opacity-0"
          }`}
        >
          <svg
        ...
        <div
          className={`absolute rotate-37 top-[2px] right-[-15px] transition-all duration-500 z-20 ${
            activeTab === "quiz" ? "opacity-100 delay-400" : "opacity-0"
          }`}
        >
          <svg
        ...
        <div
          className={`absolute rotate-117 top-[40px] left-[-12px] transition-all duration-500 z-20 ${
            activeTab === "quiz" ? "opacity-100 delay-400" : "opacity-0"
          }`}
        >
          <svg
        ...
        <div
          className={`absolute rotate-49 top-[45px] right-[-12px] transition-all duration-500 z-20 ${
            activeTab === "quiz" ? "opacity-100 delay-400" : "opacity-0"
          }`}
        >
          <svg
