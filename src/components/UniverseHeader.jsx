  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden" style={{ zIndex: 1 }}>
        ...
        <div
          className="absolute top-3/4 right-1/4 w-24 h-24 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-40 h-40 bg-gradient-to-br from-blue-400/10 to-cyan-400/10 rounded-full blur-3xl animate-pulse"
        ...
        <div
          className="absolute top-1/4 right-1/2 w-1.5 h-1.5 bg-pink-400/60 rounded-full animate-float-slow"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-3/4 left-1/2 w-1 h-1 bg-blue-400/60 rounded-full animate-float-medium"
